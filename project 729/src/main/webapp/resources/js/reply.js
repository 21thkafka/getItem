...
/*var replyService = (function() {	// HTML 코드가 로딩이 되면 자동실행을 위한 형식
...
var replyService = (function(){
	...
	function getList(param, callback, error) {
	      ...
	      $.getJSON("/replies/pages/" + bno + "/" + page + ".json",		//ReplyController가 작동
	         function(data) {		// data 댓글 목록이 실려온다. List<ReplyVO> -> ReplyPageDTO
	            if(callback) {
